# -*- test-case-name: filepath.test.test_paths.ZipFilePathTestCase -*-
...
from filepath._filepath import FilePath, _PathHelper
...
class ZipArchive(ZipPath):
    ...
    def __init__(self, archivePathname):
        ...
        """
        self.zipfile = zipfile.ZipFile(archivePathname)
